...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - DragonSword Awakening Wiki',
    description: 'Copyright and intellectual property information for DragonSword Awakening Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - DragonSword Awakening Wiki',
      description: 'Copyright and intellectual property information for DragonSword Awakening Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 DragonSword Awakening Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of DragonSword Awakening Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              DragonSword Awakening Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>Hound13 Inc.</strong> - Creators of the DragonSword: Awakening game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>DragonSword: Awakening</strong> - Trademark of the game developers</li>
              <li><strong>DragonSword Awakening Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with DragonSword Awakening Wiki.
            </p>
            ...
            <p>
              ...
              DragonSword Awakening Wiki<br />
              Email: <a href="mailto:dmca@dragonswordawakeningwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@dragonswordawakeningwiki.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "DragonSword Awakening Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: DragonSword Awakening Wiki (dragonswordawakeningwiki.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@dragonswordawakeningwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@dragonswordawakeningwiki.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@dragonswordawakeningwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@dragonswordawakeningwiki.wiki</a>
            </p>
            <p>
